import { AUDIO_FILE_FPS, BLACK_KEY_COUNT, BLOCK_BLACK_WIDTH_A, BLOCK_BLACK_WIDTH_M, BLOCK_COLOR_BLACK_A, BLOCK_COLOR_BLACK_M, BLOCK_COLOR_WHITE_A, BLOCK_COLOR_WHITE_M, BLOCK_LEN_MIN, BLOCK_WHITE_WIDTH_A, BLOCK_WHITE_WIDTH_M, CANVAS_HEIGHT, SONG_DELAY_MS, START_Y_A, START_Y_M, WHITE_KEY_COUNT, WHITE_KEY_WIDTH } from "./config";
